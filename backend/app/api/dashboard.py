...
def dashboard_summary(
    ...
    catalog_score = min(25, int((category_count / 8) * 6 + (supplier_count / 12) * 7 + (warehouse_count / 3) * 5 + (product_count / 50) * 7))
    readiness_score = min(100, int((active_users / 10) * 30 + (department_count / 7) * 25 + catalog_score + 20))
